    ...
    <div class="sidebar">
     ...
     <section class="home-section">
      ...
      <div class="content">
        ...
        <!--flex box 2-->
      <div class="content" >
      <a href="counsellor/addlform.php">
            <div class="support">
                <i class="fa-solid fa-user-tie"></i>
                <h2>Counsellor</h2>
        ...
        <!--flex box 3-->
      <div class="content">
      <a href="ITdepartment/addlform.php">
            <div class="support">
      ...
      <!--flex box 4-->
      <div class="content">
      <a href="Examdepartment/addlform.php">
            <div class="support">
                <i class="fa-solid fa-building-user"></i>
