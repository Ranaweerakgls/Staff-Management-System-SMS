   ...
   <body>
    <div class="sidebar">
        <div class="logo-details">
            <img src="exam/images/unilogo.png">
     ...
     <section class="home-section">
        ...
        <div class="home-content">
            ...
            {
                echo "<tr>";
                echo "<td>".$row["EXID"]."</td>"."<td>".$row["Fl_name"]."</td>"."<td>".$row["S_ID"]."</td>"."<td>".$row["mail"]."</td>"."</td>"."<td>".$row["Faculty"]."</td>"."<td>".$row["E_Description"]."</td>";
                echo "<tr>";  
            }
