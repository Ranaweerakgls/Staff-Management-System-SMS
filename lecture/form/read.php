    ...
    <div class="sidebar">
     ...
     <section class="home-section">
        <nav>
            ...
            <div class="back-end-user"><h2>lecture Apponitment</h2></div>
        </nav>
...
$sql="SELECT * from FROM l_apponintment";
...
if($result->num_rows>0)
{
    ...
    {
        echo "<tr>";
        echo "<td>".$row["AID"]."</td>". "<td>".$row["L_Subject"]."</td>"."<td>".$row["F_name"]."</td>"."<td>".$row["mail"]."</td> "."<td>".$row["L_Description"]."</td>"."<td>".$row["S_ID"]."</td>".$row["L_ID"]."</td>".$row["L_Date"]."</td>".$row["Approve"]."</td>".$row["Reject"]."</td>";
        echo "</tr>";
    }
    echo "</table>";
}
