    ...
    <div class="sidebar">
     ...
     <section class="home-section">
        <nav>
            ...
            <div class="back-end-user"><h2>Counsellor Apponitment</h2></div>
        </nav>
...
$sql="SELECT * from FROM c_apponintment";
...
if($result->num_rows>0)
{
    ...
    {
        echo "<tr>";
        echo "<td>".$row["AID"]."</td>". "<td>".$row["C_Subject"]."</td>"."<td>".$row["F_name"]."</td>"."<td>".$row["mail"]."</td> "."<td>".$row["C_Description"]."</td>"."<td>".$row["S_ID"]."</td>".$row["C_ID"]."</td>".$row["C_Date"]."</td>".$row["Approve"]."</td>".$row["Reject"]."</td>";
        echo "</tr>";
    }
    echo "</table>";
}
